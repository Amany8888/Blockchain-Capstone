...
contract Ownable {
    ...
    event transferOwnershipEvent (address indexed prevOwner, address indexed newOwner);
    //  2) create an internal constructor that sets the _owner var to the creater of the contract 
    constructor() internal
    {
        _owner = msg.sender;
        emit transferOwnershipEvent(address(0), msg.sender);
    }
...
contract Pausable is Ownable{
    ...
    event PausedEvent (address callerAccount);
    event unPausedEvent (address callerAccount);
   ...
   modifier paused(){
        require(_paused, "Contract is currently operational" );
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOfToken , "you can approve another one not yourself");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOfToken || isApprovedForAll(ownerOfToken, msg.sender) , "you must be the owner or approved to be authorized againes this token " );
        // TODO add 'to' address to token approvals
        require(to != address(0) , "This is not a valid address");
        _tokenApprovals[tokenId]= to ;

        // TODO emit Approval Event
        //emit Approval(msg.sender , to , tokenId ); need to check any one is true !!!
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "You aren't the token owner");
